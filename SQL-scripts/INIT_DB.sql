...
SELECT * FROM EFAH_DEV_01.T_01_EFAH_USER_TYPE;

select * from EFAH_DEV_01.T_01_EFAH_USER;

select * from EFAH_DEV_01.T_01_EFAH_AUTH;
...
USE EFAH_DEV_01;
ALTER TABLE EFAH_DEV_01.T_01_EFAH_USER ADD AVATAR_URL VARCHAR(50) after MOBILE_NUM;

UPDATE EFAH_DEV_01.T_01_EFAH_USER SET AVATAR_URL = 'http://i.pravatar.cc/300?1' WHERE USER_ID = 'S603035'
