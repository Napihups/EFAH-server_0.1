...
`
SELECT 
USER.USER_ID AS USER_ID, USER.FULLNAME AS FULLNAME, USER.EMAIL AS EMAIL, USER.MOBILE_NUM AS MOBILE_NUM, USER.AVATAR_URL AS AVATAR_URL,  UTYPE.USER_TYPE AS USER_TYPE
